...
public class MainActivity extends FragmentActivity implements DownloadCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNetworkFragment = NetworkFragment.getInstance(getSupportFragmentManager(), "https://developer.android.com/_static/images/android/touchicon-180.png");
        //mNetworkFragment = NetworkFragment.getInstance(getSupportFragmentManager(), "https://upload.wikimedia.org/wikipedia/commons/4/40/Brush-calligraphy-alphabet-a.jpg");
    }
